      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          >
            ...
            {" "}
            <span className="text-black">polished product</span>.
            <br />
            From crafting sleek <span className="text-black">UI</span> to{" "}
            <span className="text-black">integrating APIs.</span>
          </motion.h1>
        ...
        >
          ...
          <ul className="space-y-2 text-lg text-[#757575]">
            <li>
              <span>Frontend:</span> 
              Vanilla JS,
              <span className="text-black font-bold"> React.js ,Next.js</span>
            </li>
            <li>
              <span className="">Backend:</span> 
              <span className="text-black font-bold"> Node.js {" "}</span>Express.js
            </li>
            <li>
              <span className="">Databases:</span> MongoDB, <span className="text-black font-bold">{" "}MySQL</span>
            </li>
            <li>Tools:
              <span className="text-black font-bold">{" "}Docker, Git
                </span>
            </li>
            <li>
              Concepts:
              <span className="text-black font-bold"> {" "}Data Structures,
